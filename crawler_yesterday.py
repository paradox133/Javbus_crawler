...
def get_dict(url):
    ...
    for detail_url in pageparser.parser_homeurl_yesterday(url_html):
...
def main(entrance):
    ...
    print(next_page_url)
    while pageparser.if_this_page_has_word('昨日新種',downloader.get_html(next_page_url)): # while the yesterday movie box is appearing
        if next_page_url:
...
# main('https://www.javbus.com/page/5')
